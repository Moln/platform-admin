...
!function (e, define) {
    ...
    return function (e, t) {
        ...
        function s(e, t, n) {
            var i, o, r, a;
            for (n = St(n) ? n : [n], i = 0, o = n.length; o > i; i++)r = n[i], bt(r) && r.click && (a = r.name || r.text, t.on(sn + Ht, "a.k-grid-" + (a || "").replace(/\s/g, ""), {commandName: a}, At(r.click, e)))
        }

        function l(e, t, n) {
            return kt(e, function (e) {
                e = typeof e === hn ? {field: e} : e;
                var i;
                return (!f(e) || n) && (e.attributes = W(e.attributes), e.footerAttributes = W(e.footerAttributes), e.headerAttributes = W(e.headerAttributes), i = !0), e.columns && (e.columns = l(e.columns, t, i)), xt({
                    encoded: t,
                    hidden: i
                }, e)
            })
        ...
        function m(e, t, n) {
            var i = y(B(t)), o = y(z(t)), r = e.rowSpan;
        ...
        function _(t, n, i) {
            ...
            }, d = 0, h = n.length; h > d; d++)o = b(n[d], a), s[o.row] || (s[o.row] = l.eq(o.row).find(".k-header").filter(c)), r = s[o.row].eq(o.cell), r.attr(ft.attr("index"), i + d);
            return n.length
        }
        ...
        function k(e, t, n, i) {
            var o, r, a, s;
            return t.columns ? (t = t.columns, t[i ? 0 : t.length - 1]) : (o = c(t, e), r = o ? o.columns : e, a = Tt(t, r), 0 === a && i ? a++ : a != r.length - 1 || i ? (a > 0 || 0 === a && !i) && (a += i ? -1 : 1) : a--, s = Tt(n, r), t = x(r, a, n, s > a), t && t != n && t.columns ? k(e, t, n, i) : null)
        }
        ...
        function V(t) {
            var n, i, o, r, a, s, l, c, d = t.closest("table"), h = e().add(t), u = t.closest("tr"), f = d.find("tr:not(.k-filter-row)"), p = f.index(u) + t[0].rowSpan, g = ft.attr("colspan");
            if (f.length - 1 >= p) {
        ...
        function W(e) {
            e = e || {};
            var t = e.style;
            return t ? (t = t.replace(/((.*)?display)(.*)?:([^;]*)/i, "$1:none"), t === e.style && (t = t.replace(/(.*)?/i, "display:none;$1"))) : t = "display:none", xt({}, e, {style: t})
        }
        ...
        function G(t, n, i, o) {
            var r, a = t.find(">colgroup"), s = kt(n, function (e) {
        ...
        function Y(e, t, n) {
            var i = n && n.length && bt(n[0]) && "value"in n[0], o = i ? $(n)[e] : e;
        ...
        function tt(e, t) {
            var n, i, o, r;
            e = e[0], t = t[0], e.rows.length !== t.rows.length && (n = e.offsetHeight, i = t.offsetHeight, n > i ? (o = t.rows[t.rows.length - 1], yn.test(o.className) && (o = t.rows[t.rows.length - 2]), r = n - i) : (o = e.rows[e.rows.length - 1], yn.test(o.className) && (o = e.rows[e.rows.length - 2]), r = i - n), o.style.height = o.offsetHeight + r + "px")
        }
        ...
        function rt(n) {
            var i = e(n.currentTarget), o = i.is("th"), r = this.table.add(this.lockedTable), a = this.thead.parent().add(e(">table", this.lockedHeader)), s = e(n.target).is(":button,a,:input,a>.k-icon,textarea,span.k-icon,span.k-link,.k-input,.k-multiselect-wrap"), l = i.closest("table")[0];
        ...
        function st(e, n, i, o, r, a) {
            ...
            if (e) {
                if (s = e.parent()[d](Rt).first(), !s[0] && (r || e.is("th")) || !r && e[0].rowSpan > 1) {
                    if (n = at(n, i, o, r), ot(n, !0), r && !e.is(".k-header"))return N(n.find("thead:first")).eq(e.index());
                    s = n.find((r ? ">thead>" : ">tbody>") + Rt).first()
                }
                !r && e[0].colSpan > 1 && e.is(".k-header") ? e = V(e).eq(1) : e.is(".k-header") && r ? (c = H(e), e = c.eq(c.length - 2)) : (l = e.attr(ft.attr("index")), l === t || r ? l = e.index() : n.parent().prev().hasClass("k-grid-content-locked") && (l -= a), e = s.children().eq(l)), e[0] && e.is(Ft) || (e = s.children(Ft).first())
            } else e = i.find(Ot);
            return e
        }
        ...
        function dt(e, t, n, i, o) {
            var r = 2 == n.length, a = !0, s = o ? e.prevAll(zt + ":first") : e.nextAll(":visible:first");
        ...
        var ft = window.kendo, pt = ft.ui, gt = ft.data.DataSource, mt = pt.Groupable, vt = ft.support.tbodyInnerHtml, _t = ft._activeElement, yt = pt.Widget, wt = ft.keys, bt = e.isPlainObject, xt = e.extend, kt = e.map, Ct = e.grep, St = e.isArray, Tt = e.inArray, Dt = Array.prototype.push, At = e.proxy, Pt = ft.isFunction, Mt = e.isEmptyObject, Et = Math, It = "progress", Bt = "error", zt = ":not(.k-group-cell):not(.k-hierarchy-cell):visible", Lt = "tbody>tr:not(.k-grouping-row):not(.k-detail-row):not(.k-group-footer) > td:not(.k-group-cell):not(.k-hierarchy-cell)", Rt = "tr:not(.k-footer-template):visible", Ft = ":not(.k-group-cell):not(.k-hierarchy-cell):visible", Ot = Rt + ":first>" + Ft + ":first", Nt = "th.k-header:not(.k-group-cell):not(.k-hierarchy-cell)", Ht = ".kendoGrid", Vt = "edit", Ut = "save", Wt = "remove", jt = "detailInit", Gt = "filterMenuInit", qt = "columnMenuInit", $t = "change", Yt = "columnHide", Qt = "columnShow", Xt = "saveChanges", Kt = "dataBound", Zt = "detailExpand", Jt = "detailCollapse", en = "k-state-focused", tn = "k-state-selected", nn = "columnResize", on = "columnReorder", rn = "columnLock", an = "columnUnlock", sn = "click", ln = "height", cn = "tabIndex", dn = "function", hn = "string", un = "Are you sure you want to delete this record?", fn = "Delete", pn = "Cancel", gn = /(\}|\#)/gi, mn = /#/gi, vn = "[\\x20\\t\\r\\n\\f]", _n = RegExp("(^|" + vn + ")(k-group-cell|k-hierarchy-cell)(" + vn + "|$)"), yn = RegExp("(^|" + vn + ")(k-filter-row)(" + vn + "|$)"), wn = '<a class="k-button k-button-icontext #=className#" #=attr# href="\\#"><span class="#=iconClass# #=imageClass#"></span>#=text#</a>', bn = !1, xn = ft.support.browser, kn = xn.msie && 7 == xn.version, Cn = xn.msie && 8 == xn.version, Sn = yt.extend({
            init: function (e, t) {
                ...
                var e = this;
                yt.fn.destroy.call(e), e.dataSource.unbind($t, e._refreshHandler), e.wrapper.add(e.verticalScrollbar).off(Ht), e.drag && (e.drag.destroy(), e.drag = null), e.wrapper = e.element = e.verticalScrollbar = null, e._refreshHandler = null
            }, wrap: function () {
                var t, n = this, i = ft.support.scrollbar() + 1, o = n.element;
                o.css({
                    width: "auto",
                    overflow: "hidden"
                ...
                })), n.verticalScrollbar = e('<div class="k-scrollbar k-scrollbar-vertical" />').css({width: i}).appendTo(o).bind("scroll" + Ht, At(n._scroll, n))
            }, _wheelScroll: function (t) {
                if (!t.ctrlKey) {
                    var n = this.verticalScrollbar.scrollTop(), i = ft.wheelDeltaY(t);
                    i && (t.preventDefault(), e(t.currentTarget).one("wheel" + Ht, !1), this.verticalScrollbar.scrollTop(n + -i))
                }
            }, _scroll: function (e) {
                var t = this, n = !t.options.prefetch, i = e.currentTarget.scrollTop, o = t.dataSource, r = t.itemHeight, a = o.skip() || 0, s = t._rangeStart || a, l = t.element.innerHeight(), c = !!(t._scrollbarTop && t._scrollbarTop > i), d = Et.max(Et.floor(i / r), 0), h = Et.max(d + Et.floor(l / r), 0);
                ...
                var i = this, o = i.dataSource, r = i.itemHeight, a = o.take(), s = i._rangeStart || o.skip() || 0, l = Et.floor(e / a) * a, c = !1, d = .33;
                ...
                var e, t = this, n = "", i = 25e4, o = t.dataSource, r = ft.support.kineticScrollNeeded ? 0 : ft.support.scrollbar(), a = t.wrapper[0], s = t.itemHeight = t.options.itemHeight() || 0, l = a.scrollWidth > a.offsetWidth ? r : 0, c = o.total() * s + l;
            ...
            options: {
                ...
                mobile: "",
                messages: {
                    editable: {cancelDelete: pn, confirmation: un, confirmDelete: fn},
                    commands: {
            ...
            _createResizeHandle: function (t, n) {
                ...
                if (f && d.lockedContent && f.data("th")[0] !== n[0] && (f.off(Ht).remove(), f = null), f || (f = d.resizeHandle = e('<div class="k-resize-handle"><div class="k-resize-handle-inner"></div></div>'), t.append(f)), bn)i = n.position().left, u && (a = n.closest(".k-grid-header-wrap, .k-grid-header-locked"), s = xn.msie ? a.scrollLeft() : 0, l = xn.webkit ? a[0].scrollWidth - a[0].offsetWidth - a.scrollLeft() : 0, c = xn.mozilla ? a[0].scrollWidth - a[0].offsetWidth - (a[0].scrollWidth - a[0].offsetWidth - a.scrollLeft()) : 0, i -= l - c + s); else {
            ...
            _resizable: function () {
                var t, n, i, r, a, s, l, c = this, d = c.options, h = this._isMobile, u = ft.support.mobileOS ? 0 : ft.support.scrollbar();
                d.resizable && (t = d.scrollable ? c.wrapper.find(".k-grid-header-wrap:first") : c.wrapper, h ? c._positionColumnResizeHandleTouch(t) : c._positionColumnResizeHandle(t), c.resizable && c.resizable.destroy(), c.resizable = new pt.Resizable(t.add(c.lockedHeader), {
                    ...
                    resize: function (t) {
                        var o, h, f, p, g, m, v = bn ? -1 : 1, _ = i + t.x.location * v - n * v;
            ...
            _reorderContent: function (t, n, i) {
                var o, s, l, c, d = this, h = e(), u = t[0], f = p(t), g = Tt(u, O(d.columns)), m = Tt(n, O(d.columns)), v = Tt(u, F(d.columns)), _ = Tt(n, F(d.columns)), y = B(d.columns).length, w = !!n.locked, b = d.footer || d.wrapper.find(".k-grid-footer"), x = o = _;
            ...
            autoFitColumn: function (t) {
                var n, i, o, r, a, s, l, c, d, h, p, g, m, v, _, y, w, b, x = this, k = x.options, C = x.columns, S = x.lockedHeader ? N(x.lockedHeader.find(">table>thead")).filter(u).length : 0;
                if (t = "number" == typeof t ? C[t] : bt(t) ? Ct(T(C), function (e) {
                    ...
                    if (a = k.scrollable ? o.find("col:not(.k-group-col):not(.k-hierarchy-col):eq(" + n + ")").add(s.children("colgroup").find("col:not(.k-group-col):not(.k-hierarchy-col):eq(" + n + ")")).add(c.find("colgroup").find("col:not(.k-group-col):not(.k-hierarchy-col):eq(" + n + ")")) : s.children("colgroup").find("col:not(.k-group-col):not(.k-hierarchy-col):eq(" + n + ")"), h = o.add(s).add(c), p = i.outerWidth(), a.width(""), h.css("table-layout", "fixed"), a.width("auto"), h.addClass("k-autofitting"), h.css("table-layout", ""), g = Math.max(o.width(), s.width(), c.width()), m = Math.ceil(Math.max(i.outerWidth(), s.find("tr").eq(0).children("td:visible").eq(n).outerWidth(), c.find("tr").eq(0).children("td:visible").eq(n).outerWidth())), a.width(m), t.width = m, k.scrollable) {
            ...
            editCell: function (t) {
                ...
                t = e(t), n = this, i = O(n.columns)[n.cellIndex(t)], o = n._modelForContainer(t), n.closeCell(), !o || o.editable && !o.editable(i.field) || i.command || !i.field || (n._attachModelChange(o), n._editContainer = t, n.editable = t.addClass("k-edit-cell").kendoEditable({
                    fields: {
                        ...
                        n.trigger(Ut, {values: e.values, container: t, model: o}) && e.preventDefault()
                    }
            ...
            _adjustLockedHorizontalScrollBar: function () {
                var e = this.table, t = e.parent(), n = e[0].offsetWidth > t[0].clientWidth ? ft.support.scrollbar() : 0;
            ...
            _displayCell: function (e, t, n) {
                var i = this, o = {
                    storage: {},
                    count: 0
                }, r = xt({}, ft.Template, i.options.templateSettings), a = ft.template(i._cellTmpl(t, o), r);
            ...
            _editCancelClick: function (t) {
                ...
                t.preventDefault(), t.stopPropagation(), i.trigger("cancel", {
                    container: a,
                    model: r
                }) || (n = i.items().index(e(i.current()).parent()), i.cancelRow(), o && (i.current(i.items().eq(n).children().filter(Ft).first()), ot(i.table, !0)))
            },
            _createPopupEditor: function (n) {
                var i, o, r, a, s, l, c, d, h, u, f, p = this, g = "<div " + ft.attr("uid") + '="' + n.uid + '" class="k-popup-edit-form' + (p._isMobile ? " k-mobile-list" : "") + '"><div class="k-edit-form-container">', m = [], v = O(p.columns), _ = p.options.editable, y = _.template, w = bt(_) ? _.window : {}, b = xt({}, ft.Template, p.options.templateSettings);
                if (w = w || {}, y)for (typeof y === hn && (y = window.unescape(y)), g += ft.template(y, b)(n), r = 0, a = v.length; a > r; r++)i = v[r], i.command && (d = it(i.command, "edit"), d && (o = d)); else for (r = 0, a = v.length; a > r; r++)i = v[r], i.command ? i.command && (d = it(i.command, "edit"), d && (o = d)) : (g += '<div class="k-edit-label"><label for="' + i.field + '">' + (i.title || i.field || "") + "</label></div>", n.editable && !n.editable(i.field) || !i.field ? (u = {
                    storage: {},
                    count: 0
                ...
                o && bt(o) && (o.text && bt(o.text) && (l = o.text.update, c = o.text.cancel), o.attr && (h = o.attr)), p._isMobile ? (g += "</div></div>", p.editView = p.pane.append("<div data-" + ft.ns + 'role="view" data-' + ft.ns + 'init-widgets="false" class="k-grid-edit-form"><div data-' + ft.ns + 'role="header" class="k-header">' + p._createButton({
                    ...
                    close: function (i) {
                        if (i.userTriggered) {
                            ...
                            p.cancelRow(), p.options.navigatable && (p.current(p.items().eq(o).children().filter(Ft).first()), ot(p.table, !0))
                        }
                    }
                ...
                }), p._openPopUpEditor(), p.trigger(Vt, {container: f, model: n})
            },
            ...
            saveRow: function () {
                ...
                t && i && i.end() && !e.trigger(Ut, {container: t, model: n}) && e.dataSource.sync()
            },
            ...
            _confirmation: function (e) {
                var t = this, n = t.options.editable, i = n === !0 || typeof n === hn ? t.options.messages.editable.confirmation : n.confirmation;
            ...
            _createButton: function (e) {
                var n, o = e.template || wn, r = typeof e === hn ? e : e.name || e.text, a = Tn[r] ? Tn[r].className : "k-grid-" + (r || "").replace(/\s/g, ""), s = {
                    className: a,
                    text: r,
                    imageClass: "",
                    attr: "",
                ...
                return bt(e) ? (e.className && Tt(s.className, e.className.split(" ")) < 0 ? e.className += " " + s.className : e.className === t && (e.className = s.className), "edit" === r && bt(e.text) && (e = xt(!0, {}, e), e.text = e.text.edit), e.attr && (bt(e.attr) && (e.attr = i(e.attr)), typeof e.attr === hn && (n = e.attr.match(/class="(.+?)"/), n && Tt(n[1], e.className.split(" ")) < 0 && (e.className += " " + n[1]))), s = xt(!0, s, Tn[r], {text: l[r]}, e)) : s = xt(!0, s, Tn[r], {text: l[r]}), ft.template(o)(s)
            },
            ...
            _attachGroupable: function () {
                var t = this, n = t.wrapper, i = t.options.groupable, o = Nt + "[" + ft.attr("field") + "]", r = t.content ? ".k-grid-header:first " + o : "table:first>.k-grid-header " + o;
            ...
            _selectable: function () {
                ...
                c && (a.selectable && a.selectable.destroy(), c = ft.ui.Selectable.parseOptions(c), n = c.multiple, i = c.cell, a._hasDetails() && (s[s.length] = ".k-detail-row"), (a.options.groupable || a._hasFooters()) && (s[s.length] = ".k-grouping-row,.k-group-footer"), s = s.join(","), "" !== s && (s = ":not(" + s + ")"), o = a.table, l && (o = o.add(a.lockedTable)), r = ">" + (i ? Lt : "tbody>tr" + s), a.selectable = new ft.ui.Selectable(o, {
                    ...
                    if (r.keyCode === wt.SPACEBAR && e.inArray(c, o) > -1 && !s.is(".k-edit-cell,.k-header") && s.parent().is(":not(.k-grouping-row,.k-detail-row,.k-group-footer)")) {
            ...
            _clipboard: function () {
                ...
                }).on("mousedown" + Ht, Rt + ">" + Ft, At(rt, e)), e.copyHandler = At(e.copySelection, e), e.updateClipBoardState = function () {
            ...
            getTSV: function () {
                var t, n, i, o, r, a, s = this, l = s.select(), c = "	", d = s.options.allowCopy;
            ...
            current: function (e) {
                var n, i = this, o = i.options.scrollable, r = i._current, a = i.table.add(i.thead.parent());
            ...
            _scrollTo: function (e, t) {
                var n = e.tagName.toLowerCase(), i = "td" === n || "th" === n, o = e[i ? "offsetLeft" : "offsetTop"], r = e[i ? "offsetWidth" : "offsetHeight"], a = t[i ? "scrollLeft" : "scrollTop"], s = t[i ? "clientWidth" : "clientHeight"], l = o + r, c = 0;
                c = a > o ? o : l > a + s ? s >= r ? l - s : o : a, t[i ? "scrollLeft" : "scrollTop"] = c
            },
            _navigatable: function () {
                var t = this, n = At(t.current, t), i = t.table.add(t.lockedTable), o = t.thead.parent().add(e(">table", t.lockedHeader)), r = (t._isLocked(), i), a = ft.support.isRtl(t.element);
                t.options.navigatable && (t.options.scrollable && (r = i.add(o), o.attr(cn, -1)), r.off("mousedown" + Ht + " focus" + Ht + " focusout" + Ht + " keydown" + Ht), o.on("keydown" + Ht, function (e) {
                    e.altKey && e.keyCode == wt.DOWN && (n().find(".k-grid-filter, .k-header-column-menu").click(), e.stopImmediatePropagation())
                }).find("a.k-link").attr("tabIndex", -1), i.attr(cn, Et.max(i.attr(cn) || 0, 0)).on("mousedown" + Ht + " keydown" + Ht, ".k-detail-cell", function (e) {
                    e.target !== e.currentTarget && e.stopImmediatePropagation()
                }), r.on(ft.support.touch ? "touchstart" + Ht : "mousedown" + Ht, Rt + ">" + Ft, At(rt, t)).on("focus" + Ht, function () {
                    if (!ft.support.touch) {
                        var t = n();
                    ...
                    var s, l, c, d, h, u = r.keyCode, f = !1, p = !r.isDefaultPrevented() && !e(r.target).is(":button,a,:input,a>.k-icon"), g = t.options.pageable, m = t.dataSource, v = "incell" == t._editMode(), _ = r.shiftKey, y = At(t._relatedRow, t), w = n();
                    if (w && w.is("th") && (p = !0), p && u == wt.UP)n(st(w, r.currentTarget, i, o, !0, B(t.columns).length)), f = !0; else if (p && u == wt.DOWN)n(st(w, r.currentTarget, i, o, !1, B(t.columns).length)), f = !0; else if (p && u == (a ? wt.RIGHT : wt.LEFT))n(lt(w, r.currentTarget, i, o, y)), f = !0; else if (p && u == (a ? wt.LEFT : wt.RIGHT))n(ct(w, r.currentTarget, i, o, y)), f = !0; else if (p && g && wt.PAGEDOWN == u)m.page(m.page() + 1), f = !0; else if (p && g && wt.PAGEUP == u)m.page(m.page() - 1), f = !0; else if (u == wt.ENTER || wt.F2 == u) {
                        if (w = w ? w : i.find(Ot), !w.length)return;
            ...
            _initMobile: function () {
                ...
                this._isMobile = n.mobile === !0 && ft.support.mobileOS || "phone" === n.mobile || "tablet" === n.mobile, this._isMobile && (t = this.wrapper.addClass("k-grid-mobile").wrap("<div data-" + ft.ns + 'role="view" data-' + ft.ns + 'init-widgets="false"></div>').parent(), this.pane = ft.mobile.ui.Pane.wrap(t), this.view = this.pane.view(), this._actionSheetPopupOptions = e(document.documentElement).hasClass("km-root") ? {modal: !1} : {
                    align: "bottom center",
            ...
            _scrollable: function () {
                var t, n, i, o, r = this, a = r.options, s = a.scrollable, l = s !== !0 && s.virtual && !r.virtualScrollable, c = !ft.support.kineticScrollNeeded || l ? ft.support.scrollbar() : 0;
            ...
            _applyLockedContainersWidth: function () {
                if (this.options.scrollable && this.lockedHeader) {
                    var e, t = this.thead.parent(), n = t.parent(), i = this.wrapper[0].clientWidth, o = this._groups(), r = ft.support.scrollbar(), a = this.lockedHeader.find(">table>colgroup>col:not(.k-group-col, .k-hierarchy-col)"), s = t.find(">colgroup>col:not(.k-group-col, .k-hierarchy-col)"), l = A(a), c = A(s);
            ...
            _setContentHeight: function () {
                var e, t = this, n = t.options, i = t.wrapper.innerHeight(), o = t.wrapper.children(".k-grid-header"), r = ft.support.scrollbar();
            ...
            _modelChange: function (t) {
                var n, i, o, r, a, s, l, c, d, h, u = this, f = u.tbody, p = t.model, g = u.tbody.find("tr[" + ft.attr("uid") + "=" + p.uid + "]"), m = g.hasClass("k-alt"), v = u._items(f).index(g), _ = u.lockedContent;
                if (_ && (n = u._relatedRow(g)), g.add(n).children(".k-edit-cell").length && !u.options.rowTemplate)g.add(n).children(":not(.k-group-cell,.k-hierarchy-cell)").each(function () {
                    ...
                    }), r = (m ? u.altRowTemplate : u.rowTemplate)(p), g.replaceWith(r), r = u._items(f).eq(v), h = [{dataItem: p}], _ && (g = g.add(n), n = u._relatedRow(r)[0], nt(r[0], n), r = r.add(n), h.push({dataItem: p})), u.angular("compile", function () {
                    ...
                    u.trigger("itemChange", {item: r, data: p, ns: pt})
                }
            },
            _pageable: function () {
                var t, n = this, i = n.options.pageable;
                i && (t = n.wrapper.children("div.k-grid-pager"), t.length || (t = e('<div class="k-pager-wrap k-grid-pager"/>').appendTo(n.wrapper)), n.pager && n.pager.destroy(), n.pager = "object" == typeof i && i instanceof ft.ui.Pager ? i : new ft.ui.Pager(t, xt({}, i, {dataSource: n.dataSource})))
            },
            _footer: function () {
            ...
            _wrapFooter: function (t) {
                var n = this, i = "", o = ft.support.mobileOS ? 0 : ft.support.scrollbar();
            ...
            _columnMenu: function () {
                var e, n, i, o, r, a, s, l, c, d = this, h = O(d.columns), u = d.options, f = u.columnMenu, p = Ct(d.columns, function (e) {
                        return e.columns !== t
                    }).length > 0, g = this._isMobile, m = function (e) {
                    d.trigger(qt, {field: e.field, container: e.container})
                }, v = function (e) {
                    ot(e.closest("table"), !0)
                }, _ = u.$angular;
                if (f)for ("boolean" == typeof f && (f = {}), a = N(d.thead), s = 0, l = a.length; l > s; s++)n = h[s], c = a.eq(s), n.command || !n.field && !c.attr("data-" + ft.ns + "field") || (e = c.data("kendoColumnMenu"), e && e.destroy(), o = n.sortable !== !1 && f.sortable !== !1 && u.sortable !== !1 ? xt({}, u.sortable, {compare: (n.sortable || {}).compare}) : !1, r = u.filterable && n.filterable !== !1 && f.filterable !== !1 ? xt({pane: d.pane}, u.filterable, n.filterable) : !1, n.filterable && n.filterable.dataSource && (r.forceUnique = !1, r.checkSource = n.filterable.dataSource), r && (r.format = n.format), i = {
            ...
            _filterable: function () {
                var e, t, n, i, o, r, a, s = this, l = O(s.columns), c = function (e) {
                    s.trigger(Gt, {field: e.field, container: e.container})
                }, d = function (e) {
                    ot(e.closest("table"), !0)
            ...
            _columns: function (t) {
                ...
                if (t = t.length ? t : kt(a.find("th"), function (t, n) {
                        t = e(t);
                        var i = t.attr(ft.attr("sortable")), o = t.attr(ft.attr("filterable")), r = t.attr(ft.attr("type")), a = t.attr(ft.attr("groupable")), l = t.attr(ft.attr("field")), c = t.attr(ft.attr("title")), d = t.attr(ft.attr("menu"));
            ...
            _tmpl: function (e, t, o, r) {
                var a, s, l, c, d = this, h = xt({}, ft.Template, d.options.templateSettings), u = t.length, f = {
                    storage: {},
                    count: 0
            ...
            _headerCellText: function (e) {
                var t = this, n = xt({}, ft.Template, t.options.templateSettings), i = e.headerTemplate, o = typeof i, r = e.title || e.field || "";
                return o === dn ? r = ft.template(i, n)({}) : o === hn && (r = i), r
            },
            _cellTmpl: function (e, t) {
                var n, i, o = this, r = xt({}, ft.Template, o.options.templateSettings), a = e.template, s = r.paramName, l = e.field, c = "", d = e.format, h = typeof a, u = e.values;
                if (e.command) {
                    if (St(e.command)) {
            ...
            _footerTmpl: function (e, t, o, r, a) {
                var s, l, c, d, h, u = this, f = xt({}, ft.Template, u.options.templateSettings), p = f.paramName, g = "", m = {}, v = 0, _ = {}, y = u._groups(), w = u.dataSource._emptyAggregates(t);
                for (g += '<tr class="' + r + '">', y > 0 && !a && (g += n(y)), u._hasDetails() && (g += '<td class="k-hierarchy-cell">&nbsp;</td>'), s = 0, l = e.length; l > s; s++)h = e[s], c = h[o], d = typeof c, g += "<td" + i(h.footerAttributes) + ">", c ? (d !== dn && (_ = w[h.field] ? xt({}, f, {paramName: p + "['" + h.field + "']"}) : {}, c = ft.template(c, _)), m["tmpl" + v] = c, g += "#=this.tmpl" + v + "(" + p + ")#", v++) : g += "&nbsp;", g += "</td>";
                return g += "</tr>", g = ft.template(g, f), v > 0 ? At(g, m) : g
            },
            _detailTmpl: function (e) {
                var t = this, i = "", o = xt({}, ft.Template, t.options.templateSettings), r = o.paramName, a = {}, s = 0, l = t._groups(), c = p(O(t.columns)).length, d = typeof e;
            ...
            _hasFilterRow: function () {
                var t = this.options.filterable, n = t && typeof t.mode == hn && -1 != t.mode.indexOf("row"), i = this.columns, o = e.grep(i, function (e) {
            ...
            _createHeaderCells: function (e, n) {
                ...
                for (o = 0, s = e.length; s > o; o++)r = e[o].column || e[o], a = d._headerCellText(r), l = "", c = Tt(r, u), r.command ? (h += "<th" + i(r.headerAttributes), n && !e[o].colSpan && (h += " rowspan='" + n + "'"), c > -1 && (h += ft.attr("index") + "='" + c + "'"), h += ">" + a + "</th>") : (r.field && (l = ft.attr("field") + "='" + r.field + "' "), h += "<th role='columnheader' " + l, n && !e[o].colSpan && (h += " rowspan='" + n + "'"), e[o].colSpan > 1 && (h += 'colspan="' + (e[o].colSpan - D(r.columns)) + '" ', h += ft.attr("colspan") + "='" + e[o].colSpan + "'"), r.title && (h += ft.attr("title") + '="' + r.title.replace(/'/g, "'") + '" '), r.groupable !== t && (h += ft.attr("groupable") + "='" + r.groupable + "' "), r.aggregates && r.aggregates.length && (h += ft.attr("aggregates") + "='" + r.aggregates + "'"), c > -1 && (h += ft.attr("index") + "='" + c + "'"), h += i(r.headerAttributes), h += ">" + a + "</th>");
                return h
            },
            ...
            _appendLockedColumnHeader: function (t) {
                var n, i, o, r, a, s, l, c, d, h, u, p = this, m = this.columns, v = [], _ = 0, y = e(), w = p._hasFilterRow(), b = 0, x = e(), k = 0, C = e(), S = p.thead.prev().find("col:not(.k-group-col,.k-hierarchy-col)"), T = p.thead.find("tr:first .k-header:not(.k-group-cell,.k-hierarchy-cell)"), A = p.thead.find(".k-filter-row").find("th:not(.k-group-cell,.k-hierarchy-cell)"), M = 0;
                ...
                if (v.length) {
                    for (i = '<div class="k-grid-header-locked" style="width:1px"><table' + (kn ? ' cellspacing="0"' : "") + "><colgroup/><thead>", i += Array(v.length + 1).join("<tr></tr>"), i += (w ? '<tr class="k-filter-row" />' : "") + "</thead></table></div>", s = e(i), S = s.find("colgroup"), S.append(p.thead.prev().find("col.k-group-col").add(y)), r = s.find("thead tr:not(.k-filter-row)"), n = 0, o = v.length; o > n; n++)C = g(v[n]), r.eq(n).append(p.thead.find("tr:eq(" + n + ") .k-group-cell").add(C));
            ...
            _thead: function () {
                ...
                c && (o = e("<tr/>"), o.addClass("k-filter-row"), l && o.prepend('<th class="k-hierarchy-cell">&nbsp;</th>'), r = h.find(".k-filter-row"), r.length && (ft.destroy(r), r.remove()), h.append(o)), n.children().length ? l && !n.find(".k-hierarchy-cell")[0] && n.prepend('<th class="k-hierarchy-cell">&nbsp;</th>') : (d = "", l && (d += '<th class="k-hierarchy-cell">&nbsp;</th>'), d += a._createHeaderCells(s), n.html(d)), n.attr("role", "row").find("th").addClass("k-header"), a.options.scrollable || h.addClass("k-grid-header"), n.find("script").remove().end().prependTo(h), a.thead && a._destroyColumnAttachments(), this.angular("cleanup", function () {
                    ...
                    return {
                        elements: h.find("th").get(), data: kt(s, function (e) {
                            return {column: e}
                        })
                    }
            ...
            _groupRowHtml: function (e, t, n, i, o, r) {
                var a, s, l = this, c = "", d = e.field, h = Ct(O(l.columns), function (e) {
                        return e.field == d
                    })[0] || {}, u = h.groupHeaderTemplate, f = (h.title || d) + ": " + Y(e.value, h.format, h.values), p = l._groupAggregatesDefaultObject || {}, g = xt({}, p, e.aggregates), m = xt({}, {
                    field: e.field,
                    value: e.value,
                    aggregates: g
                }, e.aggregates[e.field]), v = o.groupFooterTemplate, _ = e.items;
                if (u && (f = typeof u === dn ? u(m) : ft.template(u)(m)), c += i(t, n, f), e.hasSubgroups)for (a = 0, s = _.length; s > a; a++)c += l._groupRowHtml(_[a], r ? t : t - 1, n + 1, i, o, r); else c += l._rowsHtml(_, o);
                return v && (c += v(g)), c
            },
            ...
            hideColumn: function (n) {
                var i, o, r, s, l, c, d, g, m, v, _ = this, y = 0, w = _.footer || _.wrapper.find(".k-grid-footer"), b = _.columns, x = _.lockedHeader ? N(_.lockedHeader.find(">table>thead")).filter(u).length : 0;
                if (n = "number" == typeof n ? b[n] : bt(n) ? Ct(T(b), function (e) {
                    ...
                    if (n.columns && n.columns.length) {
                        ...
                        return _.trigger(Yt, {column: n}), t
                    }
                    if (m = Tt(n, p(O(b))), h(n, !1), _._setParentsVisibility(n, !1), _._templates(), _._updateCols(), _._updateLockedCols(), v = _.thead, d = m, _.lockedHeader && x > m ? v = _.lockedHeader.find(">table>thead") : d -= x, i = N(v).filter(u).eq(d), i[0].style.display = "none", Q(a(e(">table>thead", _.lockedHeader), _.thead, ">tr.k-filter-row>th"), m, !1), w[0] && (_._updateCols(w.find(">.k-grid-footer-wrap>table")), _._updateLockedCols(w.find(">.k-grid-footer-locked>table")), Q(w.find(".k-footer-template>td"), m, !1)), _.lockedTable && x > m ? X(_.lockedTable.find(">tbody>tr"), m) : X(_.tbody.children(), m - x), _.lockedTable)_._updateTablesWidth(), _._applyLockedContainersWidth(), _._syncLockedContentHeight(), _._syncLockedHeaderHeight(), _._syncLockedFooterHeight(); else {
                        ...
                        o = e(">.k-grid-header table:first,>.k-grid-footer table:first", _.wrapper).add(_.table), _._footerWidth = null, y && (o.each(function () {
                            this.style.width = y + "px"
                        }), _._footerWidth = y), xn.msie && 8 == xn.version && (o.css("display", "inline-table"), setTimeout(function () {
                            o.css("display", "table")
                        }, 1))
                    }
                    _._updateFirstColumnClass(), _.trigger(Yt, {column: n})
                }
            },
            _setParentsVisibility: function (t, n) {
                ...
                if (d(t, c, u) && u.length)for (i = u.length - 1; i >= 0; i--)o = u[i], r = b(o, c), s = a(e(">table>thead", this.lockedHeader), this.thead, ">tr:eq(" + r.row + ")>th:not(.k-group-cell):not(.k-hierarchy-cell)").eq(r.cell), f(o) && (h(o, n), s[0].style.display = n ? "" : "none"), s.filter("[" + ft.attr("colspan") + "]").length && (l = parseInt(s.attr(ft.attr("colspan")), 10), s[0].colSpan = l - D(o.columns) || 1)
            },
            showColumn: function (n) {
                var i, o, r, s, l, c, d, u, p, g, m, v = this, _ = v.columns, y = v.footer || v.wrapper.find(".k-grid-footer"), w = v.lockedHeader ? N(v.lockedHeader.find(">table>thead")).length : 0;
                if (n = "number" == typeof n ? _[n] : bt(n) ? Ct(T(_), function (e) {
                    ...
                    if (n.columns && n.columns.length) {
                        for (d = C(n, _), h(n, !0), Q(a(e(">table>thead", v.lockedHeader), v.thead, ">tr:eq(" + d.row + ")>th"), d.cell, !0), i = 0; n.columns.length > i; i++)this.showColumn(n.columns[i]);
                        return v.trigger(Qt, {column: n}), t
                    }
                    ...
                    v._updateFirstColumnClass(), v.trigger(Qt, {column: n})
                }
            },
            ...
            _renderContent: function (e, t, n) {
                ...
                if (t = s ? t - F(R(r.columns)).length : t, n > 0)for (t = s ? t - n : t, r.detailTemplate && t++, r.groupFooterTemplate && (r._groupAggregatesDefaultObject = r.dataSource.aggregates()), i = 0, o = e.length; o > i; i++)a += r._groupRowHtml(e[i], t, 0, s ? ut : ht, l, s); else a += r._rowsHtml(e, l);
                r.tbody = U(r.tbody, r.table, a)
            },
            _renderLockedContent: function (e, t, n) {
                ...
                if (this.lockedContent) {
                    if (r = this.lockedTable, n > 0)for (t -= p(O(z(this.columns))).length, i = 0, o = e.length; o > i; i++)a += this._groupRowHtml(e[i], t, 0, ht, s); else a = this._rowsHtml(e, s);
        ...
        ft.ExcelMixin && ft.ExcelMixin.extend(Dn.prototype), ft.PDFMixin && (ft.PDFMixin.extend(Dn.prototype), Dn.prototype._drawPDF = function (n) {
            function i() {
            ...
            function o() {
                l._drawPDFShadow().done(function (e) {
            ...
            return this._initPDFProgress(n), r = new ft.drawing.Group, a = c.page(), d ? (c.bind("change", o), c.page(1)) : o(), s.promise()
